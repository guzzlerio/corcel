...
type LessThanOrEqualAssertion struct {
	Key   string
	Value interface{}
}

func (instance *LessThanOrEqualAssertion) resultKey() string {
	return fmt.Sprintf("assert:lte:%v:%v", instance.Key, instance.Value)
}

//Assert ...
func (instance *LessThanOrEqualAssertion) Assert(executionResult core.ExecutionResult) core.AssertionResult {
