...
`
	...
	Describe("waitTime", func() {
		...
		PIt("panics when waitTime does not parse", func() {
			planBuilder := NewPlanBuilder()
...
`
	...
	It("builds a plan with a after", func() {
		planBuilder := NewPlanBuilder()
...
`
	...
	It("builds a plan with a before/after", func() {
		planBuilder := NewPlanBuilder()
...
`
		...
		It("builds a plan with a before/after job", func() {
			planBuilder := NewPlanBuilder()
